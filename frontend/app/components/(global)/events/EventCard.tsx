        ...
        <div className="relative z-10 mt-6 flex gap-3">
          ...
          {showCancelButton && onCancel && (
              <button
                  ...
                  className="px-6 py-3 bg-red-600/10 hover:bg-red-600 text-red-400 hover:text-white rounded-xl transition-all duration-300 font-medium border border-red-600/30 hover:border-red-600 cursor-pointer"
              >
                Cancelar
              </button>
          )}
